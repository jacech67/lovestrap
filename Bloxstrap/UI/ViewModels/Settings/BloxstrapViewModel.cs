...
{
    public class LovestrapViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"Lovestrap-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "LovestrapViewModel::AddFilesToZipStream";
